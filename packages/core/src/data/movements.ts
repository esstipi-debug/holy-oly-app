...
export const MOVEMENT_BASES: MovementBase[] = [
  ...
  { id: "press-empuje", name: "Push press", aliasEn: "Push press", rmRef: "envion", baseComplexity: 3,
    axes: {}, allowedFlags: ["pausa"], substituteBases: ["press-hombros"] },
  { id: "press-hombros", name: "Press de hombros", aliasEn: "Strict press", rmRef: "envion", baseComplexity: 2,
