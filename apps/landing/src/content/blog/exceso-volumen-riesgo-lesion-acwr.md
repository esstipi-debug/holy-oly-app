---
title: "Acumular demasiado volumen: riesgo de lesión"
summary: Lo brusco del salto de carga respecto a tus últimas semanas predice el
  riesgo de lesión mejor que el volumen total; comparar la carga actual contra
  tu propio promedio reciente dice más que mirar un solo día pesado.
category: Rendimiento
topic: volume_injury_risk_acwr
tags:
  - volumen
  - lesión
  - rendimiento
primary_sources:
  - title: "The training-injury prevention paradox: should athletes be training
      smarter and harder?"
    authors: Gabbett TJ
...
applications:
  crossfit:
    - En semanas con muchos WODs de alto volumen sumado a levantamientos
      pesados, el volumen combinado de todas las modalidades cuenta para el
      total semanal, no solo la pesa; evitá que una semana de competencia o
      'testing' duplique el volumen habitual sin aviso previo.
    - "Programar semanas de descarga regulares ayuda a sostener una base alta
      sin picos: es preferible una progresión escalonada de volumen que alternar
      semanas muy livianas con semanas explosivas de alto volumen multi-modal."
  weightlifting:
    - Al planificar un bloque de fuerza pesado, hacelo en incrementos moderados
      semana a semana en vez de duplicar el volumen de golpe tras una semana de
      descarga.
    - Si volvés de una semana liviana, de viaje o de una competencia, subí el
      volumen de arranques/envión de forma escalonada en 2-3 semanas en vez de
      retomar directo el volumen máximo previo.
    - Llevá un registro simple de series totales o tonelaje semanal; si una
      semana particular va a superar en 15% o más el promedio de las últimas
      semanas, es una señal para revisar técnica, dolor y fatiga antes de sumar
      más carga.
contraindications:
  - Un salto brusco de volumen no siempre causa lesión, pero es un factor de
    riesgo real. Si tu coach no está ajustando la progresión, es un buen momento
    para preguntarle.
readingMinutes: 2
