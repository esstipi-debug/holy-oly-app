---
title: Qué pasa cuando levantás pesado (fuerza máxima, en general)
summary: Una serie realmente pesada no es solo un número en la barra — deja al
  cuerpo objetivamente más débil por un rato y dispara una respuesta hormonal
  que se entrena con los años.
category: Rendimiento
topic: heavy_lifting_general
tags:
  - fuerza
  - rendimiento
primary_sources:
  - title: Acute hormonal responses to heavy resistance exercise in strength
      athletes versus nonathletes
    authors: Ahtiainen JP, Pakarinen A, Kraemer WJ, Häkkinen K
    journal: Canadian Journal of Applied Physiology
    year: 2004
    doi: 10.1139/h04-034
applications:
  crossfit:
    - Meter un levantamiento pesado de fuerza máxima inmediatamente antes o en
      medio de un WOD metabólico de alto volumen suma dos tipos de fatiga
      distintos que se potencian entre sí; si programás ambos el mismo día, dale
      más espacio de recuperación entre bloques del que usarías para un WOD
      común.
    - En semanas de alto volumen con trabajo concurrente, esperá una fatiga más
      marcada y más lenta de disipar que solo con WODs; es una razón fisiológica
      real para bajar el volumen o la intensidad de los levantamientos pesados
      en esas semanas, no falta de voluntad.
  weightlifting:
    - "Después de una serie realmente pesada, tu fuerza y tu control
      neuromuscular están objetivamente reducidos por un rato: dejá pasar el
      descanso completo entre series de máximos antes de intentar otro
      levantamiento técnico exigente."
    - El dolor muscular y la sensación de fatiga tras una sesión de cargas
      máximas no son una señal de alarma sino parte esperable de la respuesta
      aguda; no confundas ese malestar normal post-entreno pesado con una
      lesión, pero tampoco lo ignores si se acumula día tras día sin bajar.
    - Si notás que tus levantamientos pesados cada vez cuestan más 'sentirlos
      fuertes' en la misma semana, puede ser la fatiga neuromuscular acumulada
