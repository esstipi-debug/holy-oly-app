---
title: Alcohol y recuperación
summary: Tomar alcohol después de entrenar reduce la velocidad a la que el
  cuerpo fabrica nuevo músculo, incluso combinado con proteína. El alcohol
  también fragmenta el sueño y recorta el sueño REM, lo que suma más fatiga
  percibida al día siguiente.
category: Nutrición
topic: alcohol_recovery
tags:
  - alcohol
  - recuperación
  - sueño
primary_sources:
  - title: Alcohol Ingestion Impairs Maximal Post-Exercise Rates of Myofibrillar
      Protein Synthesis following a Single Bout of Concurrent Training
    authors: Parr EB, Camera DM, Areta JL, Burke LM, Phillips SM, Hawley JA, Coffey VG
    journal: PLOS ONE
    year: 2014
    doi: 10.1371/journal.pone.0088384
applications:
  weightlifting:
    - "Si hay competencia o testeo de máximos al día siguiente, evitar alcohol
      la noche anterior y las horas posteriores al último entreno fuerte: es
      justo la ventana donde el músculo más necesita reparar tejido y consolidar
      la adaptación de la sesión."
    - Después de una sesión pesada de fuerza, priorizar primero la comida con
      proteína y carbohidratos y dejar pasar varias horas antes de cualquier
      consumo de alcohol, en vez de mezclarlos en el mismo momento post-entreno.
    - Si se sabe que se va a beber, conviene entrenar liviano o programar un día
      de descanso después, ya que la reparación muscular de esa sesión se verá
      comprometida esa noche.
  crossfit:
    - "En semanas de alto volumen o con dobles sesiones, el alcohol nocturno
      suma un segundo golpe a la recuperación: ya de por sí el cuerpo tiene más
      tejido que reparar, y el alcohol frena esa reparación justo cuando más se
      necesita."
    - En entrenamiento concurrente, el estudio de referencia mostró el freno a
      la reparación muscular usando exactamente ese tipo de sesión combinada,
      por lo que el efecto aplica de forma directa a esta población.
    - Si el plan incluye competir o hacer un WOD exigente al día siguiente,
