---
title: Señales de sobreentrenamiento (checklist práctico)
summary: No existe todavía un test único que confirme el sobreentrenamiento, así
  que conviene vigilar varias señales a la vez — rendimiento, cuerpo y ánimo —
  en vez de fiarse de una sola.
category: Recuperación
topic: overtraining_warning_signs
tags:
  - sobreentrenamiento
  - recuperación
primary_sources:
  - title: "Overtraining Syndrome Symptoms and Diagnosis in Athletes: Where Is the
      Research? A Systematic Review"
    authors: Jonathon Weakley, Shona L. Halson, Iñigo Mujika
    journal: International Journal of Sports Physiology and Performance
    year: 2022
    doi: 10.1123/ijspp.2021-0448
applications:
  crossfit:
    - 'Como el CrossFit combina fuerza, metabólico y a veces cardio en la misma
      semana, el riesgo de acumular fatiga de varios sistemas a la vez es mayor:
      si varios WODs seguidos te dejan con peor ánimo, sueño cortado y sensación
      de piernas "pesadas" que no mejora en 3-4 días, es la señal de bajar
      volumen general.'
    - En box con entrenamiento concurrente, conviene mirar el conjunto de
      señales — motivación, calidad de sueño, apetito y ánimo — en vez de
      fijarte solo en si mejoraste o no tu tiempo en el WOD.
  weightlifting:
    - 'Si notás que en las últimas 2-3 semanas tus levantamientos vienen más
      lentos o más pesados de lo normal en el mismo porcentaje de tu máximo, y
      además estás de peor humor y dormís peor, no lo resuelvas solo con "un día
      libre": es momento de bajar el volumen o la intensidad de la semana
      completa y avisarle a tu entrenador.'
    - Llevar un registro simple de cómo te sentís antes de cada sesión (ánimo,
      ganas, calidad de sueño la noche anterior) te da una alerta temprana más
      confiable que esperar a que baje el número en la barra, porque el
      rendimiento suele ser de los últimos indicadores en caer.
    - En bloques de mucha intensidad cerca de una competencia, un chequeo
      semanal de apetito y peso corporal puede detectar sobreentrenamiento antes
      de que afecte el arranque o el envión.
contraindications:
  - Este checklist es orientativo. Si marcás varias señales a la vez durante más
    de 1-2 semanas, avisá a tu coach antes de seguir cargando volumen.
readingMinutes: 2
